...
![飞书 Wiki 首页目录树](./images/architecture-diagram.png)
展示 Wiki 首页左侧目录树：首页 → 📊 系统概览 / 📁 技术时讯 / 📁 学习博客 三层结构。

### 截图 2：飞书 Wiki 完整目录结构

![飞书 Wiki 完整目录结构](./images/architecture-diagram.png)
展示完整展开的三层目录：
...
![技术日报总结文档](./images/daily-report-tech.png)
展示技术日报的标准化排版：🏆 今日精选 → 📌 其他值得关注 → 📈 今日趋势 → 🧠 智囊团圆桌会议

### 截图 4：学习日报总结文档（6月26日）

![学习日报总结文档](./images/daily-report-learning.png)
...
| 证据 | 形式 | 说明 |
|------|------|------|
| **系统概览 Dashboard 截图** | 截图（PNG） | `~/.hermes/cron/output/dashboard_screenshots/` 中的 PNG，展示系统统计概览 |
